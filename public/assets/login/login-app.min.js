...
class ThemeCustomizer {
    ...
    changeLayoutPosition(position) {
        this.html.setAttribute('data-layouts-position', position);
        this.config.layout.position = position;
        this.setSwitchFromConfig();
    }

    changeLayoutWidth(width, save = true) {
        this.html.setAttribute('data-layouts-width', width);
        if (save) {
    ...
    initSwitchListener() {
        ...
        document.querySelectorAll('input[name=data-layouts]').forEach(function (element) {
        ...
        document.querySelectorAll('input[name=data-layouts-position]').forEach(function (element) {
            element.addEventListener('change', function (e) {
                self.changeLayoutPosition(element.value);
            })
        });

        document.querySelectorAll('input[name=data-layouts-width]').forEach(function (element) {
            element.addEventListener('change', function (e) {
    ...
    setSwitchFromConfig() {
        ...
        if (config) {
            ...
            var layoutWidthSwitch = document.querySelector('input[type=checkbox][name=data-layouts-width][value=' + config.layout.width + ']');
            var layoutPositionSwitch = document.querySelector('input[type=checkbox][name=data-layouts-position][value=' + config.layout.position + ']');
