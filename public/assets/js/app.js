...
!(function (e, t) {
    ...
    (s.Constructor = function (e, t) {
        ...
        (s.prototype = {
            ...
            _create: function (e) {
                e = e.substr(e.indexOf("<") + 1, e.indexOf(">") - 1).replace("/", "");
            ...
            outerHeight: function (n) {
                return this._first(function (e) {
                    var t = getComputedStyle(e),
                        t = n ? parseInt(t.marginTop, 10) + parseInt(t.marginBottom, 10) : 0;
        ...
        s.extend({
            data: function (n, a) {
                var t = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,
                    o = "data-" + n.replace(/[A-Z]/g, "-$&").toLowerCase();
                return void 0 === a
                    ? this._first(function (e) {
                        if (e.data && e.data[n]) return e.data[n];
                        e = e.getAttribute(o);
                        return "true" === e || ("false" !== e && (e === +e + "" ? +e : t.test(e) ? JSON.parse(e) : e));
                    })
                    : this.each(function (e, t) {
    ...
    return (
        s.extend({
            collapse: function (n) {
                return this.each(function (e, t) {
                    t = l(t).trigger(n + ".bs.collapse");
                    "toggle" === n ? t.collapse(t.hasClass("show") ? "hide" : "show") : t["show" === n ? "addClass" : "removeClass"]("show");
                });
            },
        }),
    ...
    $(function () {
        ...
        -1 < document.body.className.indexOf("layouts-h") &&
        ((document.body.className = document.body.className.replace(/(^|\s)aside-\S+/g, "")),
            $("#chk-collapsed").prop({ disabled: !0, checked: !1 }),
            $("#chk-collapsed-text").prop({ disabled: !0, checked: !1 }),
            $("#chk-float").prop({ disabled: !0, checked: !1 }),
            $("#chk-hover").prop({ disabled: !0, checked: !1 }),
            $("#chk-scroll").prop({ disabled: !0, checked: !1 }));
    }),
    $(function () {
        var e;
        $.fn.knob &&
        ((e = { width: "50%", displayInput: !0, fgColor: APP_COLORS.info }),
            $("#knob-chart1").knob(e),
            (e = { width: "50%", displayInput: !0, fgColor: APP_COLORS.purple, readOnly: !0 }),
            $("#knob-chart2").knob(e),
            (e = { width: "50%", displayInput: !0, fgColor: APP_COLORS.info, bgColor: APP_COLORS.gray, angleOffset: -125, angleArc: 250 }),
            $("#knob-chart3").knob(e),
            (e = { width: "50%", displayInput: !0, fgColor: APP_COLORS.pink, displayPrevious: !0, thickness: 0.1, lineCap: "round" }),
            $("#knob-chart4").knob(e));
    }),
    $(function () {
...
$(function () {
        ...
        (new Chartist.Bar(
            ...
            e.on("draw", function (e) {
                ...
                o++,
                    "line" === e.type
                        ? e.element.animate({ opacity: { begin: 80 * o + 1e3, dur: r, from: 0, to: 1 } })
                        : "label" === e.type && "x" === e.axis
                            ? e.element.animate({ y: { begin: 80 * o, dur: r, from: e.y + 100, to: e.y, easing: "easeOutQuart" } })
                            : "label" === e.type && "y" === e.axis
                                ? e.element.animate({ x: { begin: 80 * o, dur: r, from: e.x - 100, to: e.x, easing: "easeOutQuart" } })
                                : "point" === e.type
                                    ? e.element.animate({
                                    ...
                                    : "grid" === e.type &&
                                    ((t = { begin: 80 * o, dur: r, from: e[e.axis.units.pos + "1"] - 30, to: e[e.axis.units.pos + "1"], easing: "easeOutQuart" }),
                                        (n = { begin: 80 * o, dur: r, from: e[e.axis.units.pos + "2"] - 100, to: e[e.axis.units.pos + "2"], easing: "easeOutQuart" }),
                                        ((a = {})[e.axis.units.pos + "1"] = t),
                                        (a[e.axis.units.pos + "2"] = n),
                                        (a.opacity = { begin: 80 * o, dur: r, from: 0, to: 1, easing: "easeOutQuart" }),
                                        e.element.animate(a));
            }),
            e.on("created", function () {
    ...
    $(function () {
        ...
        ($("[data-easypiechart]").each(function () {
            ...
            (e = { animate: { duration: 800, enabled: !0 }, barColor: APP_COLORS.success, trackColor: !1, scaleColor: !1, lineWidth: 10, lineCap: "circle" }),
            $("#easypie1").easyPieChart(e),
            (e = { animate: { duration: 800, enabled: !0 }, barColor: APP_COLORS.warning, trackColor: !1, scaleColor: !1, lineWidth: 4, lineCap: "circle" }),
            $("#easypie2").easyPieChart(e),
            (e = { animate: { duration: 800, enabled: !0 }, barColor: APP_COLORS.danger, trackColor: !1, scaleColor: APP_COLORS.gray, lineWidth: 15, lineCap: "circle" }),
            $("#easypie3").easyPieChart(e),
            (e = { animate: { duration: 800, enabled: !0 }, barColor: APP_COLORS.danger, trackColor: APP_COLORS.yellow, scaleColor: APP_COLORS["gray-dark"], lineWidth: 15, lineCap: "circle" }),
            $("#easypie4").easyPieChart(e));
    }),
    $(function () {
        var e = {
    ...
    $(function () {
        ...
        ((e = $(document)),
            ...
            0 < (n = window.navigator.userAgent).indexOf("MSIE ") || n.match(/Trident.*rv\:11\./)
                ? t.addClass("d-none")
    ...
    $(function () {
        $("[data-load-css]").on("click", function (e) {
            ...
            t
                ...
                return $("#" + t);
            })(t) || $.error("Error creating stylesheet link element.")
    ...
    (function () {
        ...
        $(function () {
            ...
            o() || e.addClass("active").children(".collapse").collapse("show");
            i.find("li > a + ul").on("show.bs.collapse", function (e) {
                o() && e.preventDefault();
            });
            var e = a.hasClass("touch") ? "click" : "mouseenter",
                n = $();
            i.find(".sidebar-nav > li").on(e, function (e) {
                (r.hasClass("aside-collapsed") || r.hasClass("aside-collapsed-text") || o()) &&
                (n.trigger("mouseleave"),
                    (n = (function (e) {
                        l();
                        var t = e.children("ul");
                        if (!t.length) return $();
                        if (e.hasClass("open")) return s(e), $();
                        var n = $(".aside-container"),
                            a = $(".aside-inner"),
                            a = parseInt(a.css("padding-top"), 0) + parseInt(n.css("padding-top"), 0),
                            o = t.clone().appendTo(n);
                        s(e);
                        (n = e.position().top + a - i.scrollTop()), (a = document.body.clientHeight);
                        return (
                            o.addClass("nav-floating").css({ position: r.hasClass("layouts-fixed") ? "fixed" : "absolute", top: n, bottom: o.outerHeight(!0) + n > a ? 0 : "auto" }),
            ...
            void 0 !== i.data("sidebarAnyclickClose") &&
            $(".wrapper").on("click.sidebar", function (e) {
                r.hasClass("aside-toggled") && ((e = $(e.target)).parents(".aside-container").length || e.is("#user-block-toggle") || e.parent().is("#user-block-toggle") || r.removeClass("aside-toggled"));
            });
        });
    })(),
    $(function () {
        ...
        $(function () {
            ...
            $("[data-toggle-state]").on("click", function (e) {
                ...
                var t = $(this),
                    ...
                    e = t.data("target"),
                    t = void 0 !== t.attr("data-no-persist"),
                    e = e ? $(e) : a;
                n && (e.hasClass(n) ? (e.removeClass(n), t || o.removeState(n)) : (e.addClass(n), t || o.addState(n))),
                    "function" == typeof Event ? window.dispatchEvent(new Event("resize")) : ((n = window.document.createEvent("UIEvents")).initUIEvent("resize", !0, !1, window, 0), window.dispatchEvent(n));
            });
        });
        var e = function () {
            var n = "jq-toggleState";
            (this.addState = function (e) {
                var t = Storages.localStorage.get(n);
                t instanceof Array ? t.push(e) : (t = [e]), Storages.localStorage.set(n, t);
            }),
                (this.removeState = function (e) {
                    var t = Storages.localStorage.get(n);
                    t && (-1 !== (e = t.indexOf(e)) && t.splice(e, 1), Storages.localStorage.set(n, t));
                }),
    ...
    $(function () {
        [].slice.call(document.querySelectorAll(".card.card-demo")).forEach(function (e) {
            e.addEventListener("card.refresh", function (e) {
                e = e.detail.card;
                setTimeout(e.removeSpinner, 3e3);
            }),
    ...
    $(function () {
        ...
        ((e = function (e) {
            var t = e.length ? e : $(e.target),
                e = t.data("output");
            window.JSON ? e.val(window.JSON.stringify(t.nestable("serialize"))) : e.val("JSON browser support required for this demo.");
        }),
            ...
            $(".js-nestable-action").on("click", function (e) {
                e = $(e.target).data("action");
                "expand-all" === e && $(".dd").nestable("expandAll"), "collapse-all" === e && $(".dd").nestable("collapseAll");
            }));
    }),
    (function () {
        function n(e) {
            var t = e.data("message"),
                e = e.data("options");
            t || $.error("Notify: No message specified"), $.notify(t, e || {});
        }
        $(function () {
            $(document);
    ...
    (function () {
        function e(e) {
            return "string" == $.type(e) && (e = { message: e }), arguments[1] && (e = $.extend(e, "string" == $.type(arguments[1]) ? { status: arguments[1] } : arguments[1])), new t(e).show();
        }
        var a = {},
            o = {},
            t = function e(t) {
        ...
        $.extend(t.prototype, {
            ...
            (t.defaults = { message: "", status: "normal", timeout: 5e3, group: null, pos: "top-center" }),
            ($.notify = e),
            ($.notify.message = t),
    ...
    (function () {
        var a = "jq-portletState";
        function t(e, t) {
            var n = Storages.localStorage.get(a);
            ((n = n || {})[this.id] = $(this).sortable("toArray")), n && Storages.localStorage.set(a, n);
        }
        function n() {
            var e,
                n,
                t = Storages.localStorage.get(a);
            !t ||
            ((t = t[(e = this.id)]) &&
                ((n = $("#" + e)),
                    $.each(t, function (e, t) {
        ...
        $(function () {
            ...
            (window.resetPorlets = function (e) {
                Storages.localStorage.remove(a), window.location.reload();
            });
    })(),
    $(function () {
        "undefined" != typeof sortable && sortable(".sortable", { forcePlaceholderSize: !0, placeholder: '<div class="box-placeholder p0 m0"><div></div></div>' });
    }),
    $(function () {
    ...
    $(function () {
        ...
        ($("#select2-1").select2({ theme: "bootstrap4" }),
            ...
            $(".select2-4").select2({ placeholder: "--Choisir--", allowClear: !0, theme: "bootstrap4" }));
    }),
    ...
    $(function () {
        ...
        (($.fn.editableform.buttons =
            ...
            $("#user .editable").on("hidden", function (e, t) {
                var n;
                ("save" !== t && "nochange" !== t) ||
                ((n = $(this).closest("tr").next().find(".editable")),
                    $("#autoopen").is(":checked")
                        ? setTimeout(function () {
                            n.editable("show");
                        }, 300)
...
($(function () {
    var e = document.getElementById("external-event-color-selector"),
        ...
        a = document.getElementById("external-event-name"),
        n = [].slice.call(e.querySelectorAll(".circle")),
        o = e.querySelector(".circle"),
        r = document.getElementById("external-events-list");
    function i(e) {
    ...
    n.forEach(function (e) {
        ...
        e.addEventListener(
            ...
            ((t = e),
                function (e) {
                    n.forEach(i), t.classList.add("selected"), (o = t);
                })
        );
    }),
        t.addEventListener("click", function () {
            ...
            ((e = getComputedStyle(o)),
                ((t = document.createElement("div")).style.backgroundColor = e.backgroundColor),
                (t.style.borderColor = e.borderColor),
                (t.style.color = "#fff"),
                (t.className = "fce-event"),
                ((t = t).innerText = n),
        ...
        new e(n, {
            events: (function () {
                var e = new Date(),
                    ...
                    e = e.getFullYear();
                return [
                    { title: "All Day Event", start: new Date(e, n, 1), backgroundColor: "#f56954", borderColor: "#f56954" },
                    { title: "Long Event", start: new Date(e, n, t - 5), end: new Date(e, n, t - 2), backgroundColor: "#f39c12", borderColor: "#f39c12" },
                    { title: "Meeting", start: new Date(e, n, t, 10, 30), allDay: !1, backgroundColor: "#0073b7", borderColor: "#0073b7" },
                    { title: "Lunch", start: new Date(e, n, t, 12, 0), end: new Date(e, n, t, 14, 0), allDay: !1, backgroundColor: "#00c0ef", borderColor: "#00c0ef" },
                    { title: "Birthday Party", start: new Date(e, n, t + 1, 19, 0), end: new Date(e, n, t + 1, 22, 30), allDay: !1, backgroundColor: "#00a65a", borderColor: "#00a65a" },
                    { title: "Open Google", start: new Date(e, n, 28), end: new Date(e, n, 29), url: "//google.com/", backgroundColor: "#3c8dbc", borderColor: "#3c8dbc" },
                ];
            })(),
            ...
            ((s = []),
                $("[data-gmap]").each(function () {
                    ...
                    if (t) {
                        ...
                        a = e
                            .gMap({ controls: { panControl: !0, zoomControl: !0, mapTypeControl: !0, scaleControl: !0, streetViewControl: !0, overviewMapControl: !0 }, scrollwheel: !1, maptype: o, markers: r, zoom: a })
                            .data("gMap.reference");
                        s.push(a), void 0 !== e.data("styled") && a.setOptions({ styles: l });
                    }
                }));
        });
        var l = [
    ...
    (function () {
        window.VectorMap = function (e, t, n) {
            ...
            ((o = e.data()),
                (a = o.height || "300"),
                (o = {
                    markerColor: o.markerColor || r.markerColor,
                    bgColor: o.bgColor || r.bgColor,
                    scale: o.scale || 1,
                    scaleColors: o.scaleColors || r.scaleColors,
                    regionFill: o.regionFill || r.regionFill,
        ...
        var r = { markerColor: "#23b7e5", bgColor: "transparent", scaleColors: ["#878c9a"], regionFill: "#bbbec6" };
    })(),
    $(function () {
        var e = {
                ...
                classHandler: function (e) {
                    ...
                    return (t = !t.length ? e.$element.parents(".c-checkbox").find("label") : t);
                },
        ...
        ($("#datatable1").DataTable({
            ...
            $("#datatable2").DataTable({
                ...
                oLanguage: {
                    ...
                    sZeroRecords: "Aucun résultat ne correspond à cette recherche.",
                    sInfoEmpty: "Aucune entrée à afficher",
                    sInfoFiltered: "(filtrées parmi _MAX_ entrées)",
                    oPaginate: { sNext: '<em class="fa fa-caret-right"></em>', sPrevious: '<em class="fa fa-caret-left"></em>' },
                },
                dom: window.restaurantDataTableDom || "Bfrtip",
                buttons: window.restaurantDataTableButtons ? window.restaurantDataTableButtons() : [
                    { extend: "copyHtml5", text: "Copier" },
                    { extend: "csvHtml5", text: "CSV" },
                    { extend: "excelHtml5", text: "Excel", title: $("title").text() },
                    { extend: "pdfHtml5", text: "PDF", title: $("title").text() },
                    { extend: "print", text: "Capturer" },
                ],
            }),
            $("#datatable3").DataTable({
                ...
                oLanguage: {
                    ...
                    info: "Affichage de la _PAGE_ sur _PAGES_",
                    zeroRecords: "Désolé, rien n'a été trouvé",
