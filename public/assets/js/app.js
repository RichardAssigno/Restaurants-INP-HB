        ...
        ($("#datatable1").DataTable({
            ...
            $("#datatable2").DataTable({
                ...
                oLanguage: {
                    ...
                    infoFiltered: "(Filtre sur _MAX_ entrées au total)",
                    oPaginate: { sNext: '<em class="fa fa-caret-right"></em>', sPrevious: '<em class="fa fa-caret-left"></em>' },
                },
                dom: "Bfrtip",
                buttons: [
                    { extend: "copy", className: "btn-secondary border-0" },
                    { extend: "csv", className: "btn-secondary border-0" },
                    { extend: "excel", className: "btn-secondary border-0", title: "XLS-File" },
                    { extend: "pdf", className: "btn-secondary border-0", title: $("title").text() },
                    { extend: "print", className: "btn-secondary border-0" },
                ],
            }),
